      ...
      <header className="absolute top-0 left-0 right-0 z-20 px-6 lg:px-[120px] py-[16px] transparent font-manrope">
        <nav className="flex items-center justify-between w-full max-w-[1320px] mx-auto">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <button onClick={() => window.open("http://localhost:3000", "_blank")} className="text-sm text-white font-medium hover:opacity-80 transition-opacity cursor-pointer">Docs</button>
            <button onClick={() => window.open("http://localhost:3000/smart-contracts", "_blank")} className="text-sm text-white font-medium hover:opacity-80 transition-opacity cursor-pointer">Contracts</button>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 bg-black z-50 flex flex-col p-6 font-manrope">
          ...
          <div className="flex flex-col items-center justify-center flex-1 gap-8 text-center mt-10">
            ...
            <button onClick={() => { setMobileMenuOpen(false); window.open("http://localhost:3000", "_blank"); }} className="text-2xl text-white font-medium hover:opacity-80 cursor-pointer">Docs</button>
            <button onClick={() => { setMobileMenuOpen(false); window.open("http://localhost:3000/smart-contracts", "_blank"); }} className="text-2xl text-white font-medium hover:opacity-80 cursor-pointer">Contracts</button>
            ...
            <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2 font-sans text-sm">
                  ...
                  <button onClick={() => window.open("http://localhost:3000", "_blank")} className="text-left text-neutral-400 hover:text-white transition-colors duration-200 cursor-pointer">Documentation</button>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2 font-sans text-sm">
                  <button onClick={() => window.open("http://localhost:3000/smart-contracts", "_blank")} className="text-left text-neutral-400 hover:text-white transition-colors duration-200 cursor-pointer">Smart Contracts</button>
                  <button onClick={() => window.open("http://localhost:3000/accuracy-math", "_blank")} className="text-left text-neutral-400 hover:text-white transition-colors duration-200 cursor-pointer">Audit Reports</button>

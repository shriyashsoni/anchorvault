  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center overflow-x-hidden w-full font-sans antialiased">
      ...
      <header className="absolute top-0 left-0 right-0 z-20 px-6 lg:px-[120px] py-[16px] transparent font-manrope">
        <nav className="flex items-center justify-between w-full max-w-[1320px] mx-auto">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <button onClick={() => { setCurrentView("docs"); setDocsTab("getting-started"); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="text-sm text-white font-medium hover:opacity-80 transition-opacity cursor-pointer">Docs</button>
            <button onClick={() => { setCurrentView("docs"); setDocsTab("smart-contracts"); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="text-sm text-white font-medium hover:opacity-80 transition-opacity cursor-pointer">Contracts</button>
          </div>
      ...
      {mobileMenuOpen && (
        <div className="fixed inset-0 bg-black z-50 flex flex-col p-6 font-manrope">
          ...
          <div className="flex flex-col items-center justify-center flex-1 gap-8 text-center mt-10">
            ...
            <button onClick={() => { setMobileMenuOpen(false); setCurrentView("docs"); setDocsTab("getting-started"); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="text-2xl text-white font-medium hover:opacity-80 cursor-pointer">Docs</button>
            <button onClick={() => { setMobileMenuOpen(false); setCurrentView("docs"); setDocsTab("smart-contracts"); window.scrollTo({ top: 0, behavior: 'smooth' }); }} className="text-2xl text-white font-medium hover:opacity-80 cursor-pointer">Contracts</button>
      ...
      <div className="w-full max-w-[1400px] mx-auto flex flex-col items-center">
        ...
        >
          <FeaturesGrid onNavigate={() => { setCurrentView("docs"); setDocsTab("smart-contracts"); window.scrollTo({ top: 0, behavior: 'smooth' }); }} />
        </motion.div>
